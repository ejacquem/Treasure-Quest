...
public class PlayGameSwingView extends SwingView implements PlayGameView {
	...
	private static final int TILE_SIZE = 30;//128
	...
	/**
	 * Réagit aux touches du clavier, en particulier les touches fléchées. (+ ZQSD for direction)
	 * 
	 * */
	@Override
	public void onKeyTyped(int keyCode) {
		keyCode = convertZQSDtoArrows(keyCode);
	...
	private int convertZQSDtoArrows(int keyCode) {
		switch (keyCode) {
			case KeyEvent.VK_Z:return KeyEvent.VK_UP;
			case KeyEvent.VK_Q:return KeyEvent.VK_LEFT;
